    ...
    <div class="row">
        <div class="col-md-4">
            <div class="category-list">
                ...
                <ul>
                    <li><a href="#" class="list-active">Анестезиологическая рабочий станций</a></li>
                    <li><a href="#">Модульные мониторы пациента</a></li>
                    <li><a href="#">Откашливатели</a></li>
                    <li><a href="#">Аппараты искусственной вентиляции легких</a></li>

                    <li><a href="#">Сонная терапия</a></li>
                    <li><a href="#">Диагностика сна</a></li>
                    <li><a href="#">Aнализатор билирубина</a></li>
        ...
        <div class="col-md-8">
            <div class="catalog-info">
                ...
                <div class="catalog-block row">
                    <div class="col-md-4">
                        <img class="catalog-img" src="style/img/1.png" alt="">
                    </div>
